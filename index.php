...
@keyframes waves{
  ...
  <footer id="footer" class="footer">
      ...
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-info">
          <a href="index.html" class="logo d-flex align-items-center">
            <span>Habesha Tech</span>
          </a>
          <p>With Our Skills Put Together, You Get An Ensemble Capable Of Doing Anything And Everything Your Brand Needs.</p>
             <h6>Subscribe Here To Get Our Latest Updates.</h6>
    ...
    <div class="container mt-4">
      <div class="copyright">
        &copy; Copyright <strong><span>Habesha Tech</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
